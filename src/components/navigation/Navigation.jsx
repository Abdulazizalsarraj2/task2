...
export default function Navbar() {
  ...
  return (
    <nav className="relative z-20 w-full flex justify-center py-4 px-4 sm:px-6 lg:px-8 mx-auto">
      <div
        className={`
          fixed top-4 w-[90%]
          rounded-full shadow-md
      ...
      >
        ...
        <ul className="hidden lg:flex items-center gap-6 text-sm lg:text-[16px] text-[#120E23] font-medium flex-row-reverse">
          ...
          <li className="hover:text-[#6A35FF] hover:font-semibold cursor-pointer"><a href='#'>الرئيسية</a></li>
          <li className="hover:text-[#6A35FF] hover:font-semibold cursor-pointer"><a href='#our-services'>خدماتنا</a></li>
          <li className="hover:text-[#6A35FF] hover:font-semibold cursor-pointer"><a href='#about-us'>من نحن</a></li>
          <li className="hover:text-[#6A35FF] hover:font-semibold cursor-pointer"><a href='#our-team'>الفريق</a></li>
          <li className="hover:text-[#6A35FF] hover:font-semibold cursor-pointer"><a href='#'>الأعمال</a></li>
          <li className="hover:text-[#6A35FF] hover:font-semibold cursor-pointer"><a href='#request-a-service'>اطلب خدمة</a></li>
          <li className="hover:text-[#6A35FF] hover:font-semibold cursor-pointer"><a href='#contact-us'>تواصل معنا</a></li>
        </ul>
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden fixed top-24 inset-x-0 mx-auto w-[90%] max-w-md bg-white rounded-xl shadow-md px-6 py-4 z-50">
          <ul className="flex flex-col items-end gap-4 text-sm text-gray-800 font-medium">
            ...
            <li className="hover:text-[#6A35FF] cursor-pointer" onClick={() => setMobileMenuOpen(false)}><a href='#'>الرئيسية</a></li>
            <li className="hover:text-[#6A35FF] cursor-pointer" onClick={() => setMobileMenuOpen(false)}><a href='#our-services'>خدماتنا</a></li>
            <li className="hover:text-[#6A35FF] cursor-pointer" onClick={() => setMobileMenuOpen(false)}><a href='#about-us'>من نحن</a></li>
            <li className="hover:text-[#6A35FF] cursor-pointer" onClick={() => setMobileMenuOpen(false)}><a href='#our-team'>الفريق</a></li>
            <li className="hover:text-[#6A35FF] cursor-pointer" onClick={() => setMobileMenuOpen(false)}><a href='#'>الأعمال</a></li>
            <li className="hover:text-[#6A35FF] cursor-pointer" onClick={() => setMobileMenuOpen(false)}><a href='#request-a-service'>اطلب خدمة</a></li>
            <li className="hover:text-[#6A35FF] cursor-pointer" onClick={() => setMobileMenuOpen(false)}><a href='#contact-us'>تواصل معنا</a></li>
            <button dir='rtl' className="flex items-center gap-2 bg-[#9E7BFF] text-white text-sm px-4 py-2 rounded-full shadow hover:bg-[#835eff] transition-all w-fit mt-2">
              <img src={PhoneIcon} alt="phone-icon" className='w-3 h-3 ml-1' />
              <span className="material-icons text-sm">ابدأ الآن</span>
            </button>
