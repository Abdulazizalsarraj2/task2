...
import teamImage2 from "../../assets/team-section/11.png"
const AboutUs = () => {
  return (
    <>
    ...
    <div id='our-team'>
        <div
          className="w-full h-[450px] bg-center bg-cover flex flex-col  justify-start items-center py-6"
          style={{ backgroundImage: `url(${teamImage2})` }}
        >
      <h1 className=' text-5xl text-white  font-bold text-[48px] text-center mt-8  mb-2'> فريقنا</h1>
          ...
          <p className="max-w-[757px] text-[#efedf8] text-sm lg:text-xl text-center leading-[1.75]">
